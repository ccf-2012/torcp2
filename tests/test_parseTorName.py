...
@pytest.mark.parametrize("test_input, e1, e2, e3, e4", [
    ...
    ('HunanTV.Da.Wan.Zai.De.Ye.20211201.HDTV.1080i.H264-HDSTV.ts', 'Da Wan Zai De Ye', '2021', '', ''),
    ('2021.FIVB.VNL.CHN.vs.BRA.20210608.1080p.REPACK.WEB-DL.x264.AAC-TJUPT.mp4', '2021 FIVB VNL CHN vs BRA', '2021', '', ''),
    ('失落的秘符.第1季', '失落的秘符', '', 'S01', ''),
    ...
    ('[吸血鬼同盟][Dance In The Vampire Bund][ダンスインザヴァンパイアバンド][BDMV][1080p][DISC×2][GER]', 'Dance In The Vampire Bund  ダンスインザヴァンパイアバンド', '', '', ''),
    ...
    ('Who\'s.the.Murderer.2022.S07E05.PartA.1080p.WEB-DL.H264.AAC-TJUPT', 'Who\'s the Murderer', '2022', 'S07', 'E05'),
    ...
    ('Re：从零开始的异世界生活 S01+S02 全50话 声优：小林裕介 高桥李依 *内封中字* Re.Zero.kara.Hajimeru.Isekai.Seikatsu.Netflix.WEB-DL.1080p.x264.DDP-HDCTV', 'Re：从零开始的异世界生活', '', 'S01+S02', ''),
    ('人工智能4K REMUX (2001)', '人工智能', '2001', '', ''),
...
def test_parseTorName(test_input, e1, e2, e3, e4):
    ...
    assert e1 == tt.title and e2 == tt.year and e3 == tt.season 
...
@pytest.mark.parametrize("test_input, e1, e2", [
    ...
    ('FIFA.WORLD.CUP.QUALIFIERS.ENG.VS.ALB.20211113.1080i.HDTV.H264.DD-PTerTV.ts', 'Movie', 'PTerTV'),
    ...
    ('Adele.-.[Live.At.The.Royal.Albert.Hall].2011.Blu-Ray.1080I.H264.DTS-HDMA.-TTG', 'MovieBDMV', 'TTG'),
    ...
    ('[故宫].全12集.简繁特效.2005.AVC.1080p.HDTV.H264.AC-3.DD2.0-@szdqwx', 'TV', 'szdqwx'),
    ...
    ('谭咏麟94纯金曲演唱会.Alan.Tan.live.in.HongKong.1994.D9&LD.HEVC.10bit.2Audio.MiniSD-XPcl@PTer', 'MovieEncode', 'PTer'),
...
@pytest.mark.parametrize("test_input, e1, e2, e3", [
    ('StickySticky Thanksgiving 2023 2160p USA UHD BluRay HEVC DV TrueHD 7.1 Atmos-DIY@Audies',
     'bluray', 'HEVC DV', 'TrueHD 7.1 Atmos'),
    ('The Crimson Rivers 2000 2160p UHD Blu-ray DoVi HDR10 HEVC DTS-HD MA 5.1-NOGROUP',
     'bluray', 'DoVi HDR10 HEVC', 'DTS-HD MA 5.1'),
    ('Tower of God S02E14 Meeting the Traveler REPACK 1080p CR WEB-DL AAC 2.0 H.264-VARYG', 'webdl',
     'H.264', 'AAC 2.0'),
    ('Ink Master S16E04 1080p WEB h264-EDITH', 'webdl', 'h264', ''),
    ('American Sports Story S01E08 DV 2160p WEB H265-ASS ', 'webdl', 'H265', ''),
    ('Are You Smarter Than a Celebrity S01E05 1080p WEB h264-EDITH', 'webdl', 'h264', ''),
    ('Outer Banks S04E06-E10 2024 1080p NF WEB-DL x264 DDP5.1 Atmos-ADWeb', 'webdl', 'x264', 'DDP5.1 Atmos'),
    ('The Pink Panther 2 2009 4K WEB-DL H265 AAC-PTerWEB', 'webdl', 'H265', 'AAC'),
    ('The Wild Robot 2024 2160p iTunes WEB-DL DDP 5.1 Atmos DV HDR H.265-sh@CHDBits', 'webdl', 'H.265', 'DDP 5.1 Atmos'),
    ('The 4 30 Movie 2024 BluRay 1080p TrueHD7.1 x265.10bit-CHD', 'encode', 'x265', 'TrueHD7.1'),
    ('The Tai-chi Master 1993 GBR BluRay Remux UHD DoVi HDR 2160p LPCM2.0-CHD', 'remux', 'DoVi HDR', 'LPCM2.0'),
    ('"Keeping Score" Berlioz Symphony Fantastique 2009 Bluray 1080p TrueHD7.1 x264-CHD', 'encode', 'x264', 'TrueHD7.1')
])    
