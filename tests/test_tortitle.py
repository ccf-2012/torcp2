...
TEST_CASES = [
    ...
    ('2001太空漫游4K REMUX', {'title': '2001太空漫游', 'cntitle': '2001太空漫游', 'year': '', 'type': 'movie', "season": '', "episode": ''}),
    ('代号47 4K REMUX (2015)', {'title': '代号47', 'cntitle': '代号47', 'year': '2015', 'type': 'movie', "season": '', "episode": ''}),
]
